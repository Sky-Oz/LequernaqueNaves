...
var estadoPrincipal={
	preload: function(){
		...
		juego.load.image('enemigo','img/en1.png');
		juego.load.image('enemigo2','img/en1.png');
		juego.load.image('enemigo3','img/en1.png');
		juego.load.image('enemigo4','img/en1.png');
		juego.load.image('enemigo5','img/en1.png');
	...
	create: function(){
		...
		texto = juego.add.text(0,525,"GROVER ",{font:"20px Arial", fill:"#000000", align:"center"});
